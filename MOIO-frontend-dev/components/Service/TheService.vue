  ...
  >
    ...
    >
      ...
      >
        ...
        <div 
          v-if="capabilities?.find(el => el.type.includes('devices.capabilities.color_setting'))" 
          :style="`background: rgb(${Math.round(color.red*255)},${Math.round(color.green*255)},${Math.round(color.blue*255)});`" 
          class="service-ico-wrapper__color" 
        />
        <ui-button @click.stop="isCapabilitiesShow = true" >
          <ui-icon 
            style="z-index: 2;" 
            name="header/dots-horizontal" 
            size="28" 
            class="setting"
          />
        </ui-button>
    ...
    <delete-confirmation v-if="canEdit" ref="deleteModal" :is-modal-open="isDeleteModalShow" @cancel="isDeleteModalShow = false" @delete="deleteDevice()">
      <template #heading>
        ...
        <div class="change-icon-modal" role="dialog">
          <div class="scrollable-content scrollable-content--with-padding">
            <div class="change-icon-modal__header">
              <ui-button class="blank close-button" @click="closeSelectIconModal">
            ...
            <ui-button class="change-icon-modal__submit" variant="secondary" @click="isIconModalShow = false">
              Сохранить
            </ui-button>
          </div>
        </div>

<template>
  <div class="scenarios-create">
    ...
    <div class="scenarios-create__search">
      ...
      <label v-if="!isChangeName" class="scenarios-create__search-name">{{ scenarioName }} <ui-icon
        style="cursor: pointer;" name="pencil" @click="isChangeName = !isChangeName"
      /></label>
      <div v-if="isChangeName" class="scenarios-create__search-input">
    ...
    <div class="scenarios-create__test">
      <button @click="executeScenario">
        <ui-icon name="play" size="20" />Проверить сценарий
      </button>
      <button @click="deleteScenario()">
      ...
      <div class="scenarios-create__selected-list-group">
        <div class="scenarios-create__selected-list-group-devices">
          <scenario-service
            ...
            @toggle-device="e=>{turnOnDevice(e)}"
          />
        </div>
      </div>
    </div>

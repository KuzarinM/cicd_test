...
import useSelectOnlySmartMeters from "~/composables/useSelectOnlySmartMeters"
...
const { isAddRoommates, group, canEdit, home } = storeToRefs(groupStore)
...
const meters = useSelectOnlySmartMeters(await groupStore.getGroupById(groupStore.currentHome))
</script>
